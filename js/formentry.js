...
// Get form div and add form button
const formDiv = document.querySelector('#details');
const addFormBtn = document.getElementById('myButton');
...
function addForm() {
  // Clone the form div
  const newForm = formDiv.cloneNode(true);
